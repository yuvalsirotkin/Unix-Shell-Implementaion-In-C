...
//void exitCommand (char** arr, int len);
//void execCommand (char** arr, int len, int* numberOfProcess, struct process* processArray[]) ;
//void cdCommand (char** arr, int len);
//void jobsCommand (char** arr, int len);
//void historyCommand (char** arr, int len);
...
//    while (!exit) {
//        printf("should be add in main %d\n", &numberOfProcess);
//        printf("should be number in main %d\n", numberOfProcess);
//        char temp;
//        char inst[100];
//        int i = 0;
...
////        for (int i = 0; i < len; i++) {
////            arrayToExecv[i] = array [i];
////        }
////        //arrayToExecv[len-2] = NULL;
////        //arrayToExecv[len-1] = '\0';
////        for (int i = 0; i <= len; i++) {
////            printf ("test arr: %s\n" ,arrayToExecv[i]);
////        }
//        // end of testers
...
//        printf("should be number in main before up %d\n", numberOfProcess);
...
//        } else {
//            execCommand(arrayToExecv, len-1, numberOfProcess, processArray);
//            printf("do should be number in do comm %d\n", *numberOfProcess);
//        }
//    }
//    else {
//        printf("fore\n");
...
//        } else {
//            execCommand(arrayToExecv, len, numberOfProcess, processArray);
//        }
//    }
//
//}
